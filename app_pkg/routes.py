...
from config import FAQ_PATH, SERVICE_FOR_SERVICE_PATH, HOURLY_SERVICES_SHIFT_PATH , USER_DATA_PATH , SESSION_HISTORY_PATH , SAVE_ADDRESS_PATH , FIXED_PACKAGE_PATH
